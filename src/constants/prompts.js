...
- ตัวอย่างที่ต้อง confidence = 0.95: "กินข้าว 80", "ข้าวมันไก่ 80", "กาแฟ 45", "ค่าน้ำ 300", "ค่าแท็กซี่ 150", "เงินเดือน 25000", "โบนัส 3000", "ขายของได้ 500", "ถูกหวย 500"
...
กฎแยกประเภท (ห้ามพลาด):
- ถ้ามีเครื่องหมาย "+" หรือ keyword "อั่งเปา", "ขาย", "ได้เงิน", "รายรับ", "แม่ให้", "โบนัส", "เงินเดือน", "ถูกหวย", "รางวัล", "ได้รับ" -> ต้องเป็น "รายรับ" เสมอ!
- ห้ามใช้ตรรกะว่าชื่ออาหารต้องเป็นรายจ่าย ถ้าผู้ใช้พิมพ์ว่า "ขายข้าวมันไก่ได้ 500" -> ต้องเป็น "รายรับ"
- "โอนให้" / "โอนไป" -> รายจ่าย
- "โอนมา" / "ลูกค้าโอน" / "ได้รับโอน" -> รายรับ
